	...
	<body>
		<form action ="<%=request.getContextPath()%>/insert">
			<table align="center" >
				<tr>
					<td><br><br>メールアドレス：</td>
					<td><br><br><br><input type="text" placeholder="例：example@gmail.com" name="userEmail"><br><br></td>
				</tr>
				...
				<tr>
					<td>年齢：</td>
					<td><input type="number" min="5" max="130" name="userAge">歳</td>
				</tr>
				...
				<tr>
				<td></td>
					<td> <br><br><input type="submit" value="確認画面へ"></td>
				</tr>
